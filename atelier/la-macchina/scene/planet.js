/* ============================================================
   PLANET — dal template GetLayers `ascend`, preso COME ARRIVA.

   Questo file è lo strato che il contratto GetLayers marca `preserve`: la
   tecnica e il movimento non sono nostri e non si riscrivono. Le uniche due
   modifiche rispetto all'originale sono di percorso, non di sostanza:
   ...
   versioni recenti non esistono più (il nostro three di sito è r128 UMD, quello
   della radice r185). Sta in /atelier/vendor/three-150/, con i suoi addon.

   initPlanet(canvas) costruisce la scena e torna una funzione di pulizia.
============================================================ */
import * as THREE from 'three'
import { EffectComposer } from '/atelier/vendor/three-150/jsm/postprocessing/EffectComposer.js'
import { RenderPass } from '/atelier/vendor/three-150/jsm/postprocessing/RenderPass.js'
import { UnrealBloomPass } from '/atelier/vendor/three-150/jsm/postprocessing/UnrealBloomPass.js'
import { ShaderPass } from '/atelier/vendor/three-150/jsm/postprocessing/ShaderPass.js'
import { GammaCorrectionShader } from '/atelier/vendor/three-150/jsm/shaders/GammaCorrectionShader.js'
import { CopyShader } from '/atelier/vendor/three-150/jsm/shaders/CopyShader.js'
import { GLTFLoader } from '/atelier/vendor/three-150/jsm/loaders/GLTFLoader.js'
import { DRACOLoader } from '/atelier/vendor/three-150/jsm/loaders/DRACOLoader.js'
import { OrbitControls } from '/atelier/vendor/three-150/jsm/controls/OrbitControls.js'
